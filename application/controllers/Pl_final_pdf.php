...
class Pl_final_pdf extends CI_Controller{
  ...
  function pageCetak() {
    ...
    $kolom1 = ($this->lengthCell * 5) / 21;
    $kolom2 = ($this->lengthCell * 2) / 21;
    $kolom3 = ($this->lengthCell * 2) / 21;
    $kolom4 = ($this->lengthCell * 2) / 21;
    $kolom5 = ($this->lengthCell * 2) / 21;
    $kolom6 = ($this->lengthCell * 2) / 21;
    $kolom7 = ($this->lengthCell * 2) / 21;
    $kolom8 = ($this->lengthCell * 2) / 21;
    $kolom9 = ($this->lengthCell * 2) / 21;
