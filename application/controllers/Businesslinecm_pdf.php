...
class Businesslinecm_pdf extends CI_Controller{
  ...
  function pageCetak() {
    ...
    $sql = "SELECT s01 plitemname,
                    ...
                    n08 infraamt,
                    n09 totalamt
            FROM table (f_ShowBusinessLineCM(".$periodid_fk."))";
    ...
    $pdf->Ln(8);
    $pdf->Cell($this->lengthCell, $this->height, "Model Current Month ".$period_code."", "", 0, 'L');
    $pdf->Ln(8);
