...
class Simpletotalytd_pdf extends CI_Controller{
    ...
    function pageCetak() {
        ...
        $sql = "SELECT n01 counterno,
                        ...
                        n12 novamt,
                        n13 decamt
                FROM table (f_SimpleTotalYTD(".$year_id."))";
        ...
        $html .= '</tr>';
        $html .= '<tr>';
        $html .= '<td style="font-size: 12pt;"><strong>Model Year to date '.$year_id.'</strong></td>';
        $html .= '</tr>';
        $html .= '</table>';
