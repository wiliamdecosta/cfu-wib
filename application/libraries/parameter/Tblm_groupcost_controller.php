...
/**
* Json library
* @class Tblm_groupcost_controller
...
class Tblm_groupcost_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','x.groupcostid_pk');
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('parameter/tblm_groupcost');
            $table = $ci->tblm_groupcost;
            ...
            $data['success'] = true;
            logging('view data tblm_groupcost');
        }catch (Exception $e) {
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data tblm_groupcost');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data tblm_groupcost');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data tblm_groupcost');
            $table->db->trans_commit(); //Commit Trans
...
/* End of file Tblm_groupcost_controller.php */