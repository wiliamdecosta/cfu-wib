...
/**
* Json library
* @class Tblm_pcaactivityplmap_controller
...
class Tblm_pcaactivityplmap_controller {
    ...
    function read() {
        ...
        try {
            ...
            $data['success'] = true;
            logging('view data tblm_pcaactivityplmap');
        }catch (Exception $e) {
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data tblm_pcaactivityplmap');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data tblm_pcaactivityplmap');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data tblm_pcaactivityplmap');
            $table->db->trans_commit(); //Commit Trans
