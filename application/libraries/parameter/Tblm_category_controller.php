...
/**
* Json library
* @class Tblm_category_controller
...
class Tblm_category_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('parameter/tblm_category');
            $table = $ci->tblm_category;
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data tblm_category');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data tblm_category');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data tblm_category');
            $table->db->trans_commit(); //Commit Trans
