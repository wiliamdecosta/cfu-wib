...
/**
* Json library
* @class Tblm_plitemgroup_controller
...
class Tblm_plitemgroup_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('parameter/tblm_plitemgroup');
            $table = $ci->tblm_plitemgroup;
            ...
            $data['success'] = true;
            logging('view data tblm_plitemgroup');
        }catch (Exception $e) {
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data tblm_plitemgroup');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data tblm_plitemgroup');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data tblm_plitemgroup');
            $table->db->trans_commit(); //Commit Trans
