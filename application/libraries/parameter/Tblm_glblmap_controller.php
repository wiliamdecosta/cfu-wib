...
class Tblm_glblmap_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('parameter/tblm_glblmap');
            $table = $ci->tblm_glblmap;
            ...
            if(!empty($i_search)) {
                $table->setCriteria("( upper(a.glaccount) like upper('%".$i_search."%') OR
                                            ...
                                            upper(a.gldesctelin) like upper('%".$i_search."%') 
                                            )");
            }
            ...
            $data['success'] = true;
            logging('view data tblm_glblmap');
        }catch (Exception $e) {
    ...
    function readLovGL() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('parameter/tblm_glplitem_new');
            $table = $ci->tblm_glplitem_new;
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data tblm_glblmap');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data tblm_glblmap');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data tblm_glblmap');
            $table->db->trans_commit(); //Commit Trans
