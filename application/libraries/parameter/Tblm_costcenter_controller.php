...
/**
* Json library
* @class Tblm_costcenter_controller
...
class Tblm_costcenter_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','cccode');
        ...
        try {
            ...
            $data['success'] = true;
            logging('view data tblm_costcenter');
        }catch (Exception $e) {
        ...
        try {
            ...
            if(!empty($searchPhrase)) {
                $table->setCriteria("( upper(cccode) like upper('%".$searchPhrase."%') OR
                                         upper(ccname) like upper('%".$searchPhrase."%') OR
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data tblm_costcenter');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data tblm_costcenter');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data tblm_costcenter');
            $table->db->trans_commit(); //Commit Trans
...
/* End of file Tblm_costcenter_controller.php */