...
/**
* Json library
* @class Tblm_activitytype_controller
...
class Tblm_activitytype_controller {
        ...
        try {
            ...
            if(!empty($i_search)) {
                $table->setCriteria("(upper(code) like upper('%".$i_search."%') OR
                                         upper(acttypename) like upper('%".$i_search."%')
                                         )");
            ...
            $data['success'] = true;
            logging('view data tblm_activitytype');
        }catch (Exception $e) {
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data tblm_activitytype');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data tblm_activitytype');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data tblm_activitytype');
            $table->db->trans_commit(); //Commit Trans
