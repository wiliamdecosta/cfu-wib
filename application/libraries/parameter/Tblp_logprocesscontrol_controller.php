...
/**
* Json library
* @class Tblp_logprocesscontrol_controller
...
class Tblp_logprocesscontrol_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','counterno');
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('parameter/tblp_logprocesscontrol');
            $table = $ci->tblp_logprocesscontrol;
