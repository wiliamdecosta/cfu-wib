...
/**
* Json library
* @class Tblm_segregationother_controller
...
class Tblm_segregationother_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','a.ubiscode, a.activitygroupcode');
        ...
        try {
            ...
            if(!empty($i_search)) {
                $table->setCriteria("(upper(a.activitygroupcode) like upper('%".$i_search."%') OR
                                         upper(a.activitycode) like upper('%".$i_search."%') OR
                                         upper(a.plitemname) like upper('%".$i_search."%') OR
            ...
            $data['success'] = true;
            logging('view data tblm_segregationother');
        }catch (Exception $e) {
    ...
    function crud() {
     ...
     function readLov() {
        ...
        try {
            ...
            if(!empty($ubiscode)) {
                $table->setCriteria("upper(a.ubiscode) = upper('".$ubiscode."') AND
                                      upper(a.activitygroupcode) like upper('%DEPRECIATION%') OR
                                      upper(a.activitygroupcode) like upper('%AMORTIZATION%')");
            }
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data tblm_segregationother');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data tblm_segregationother');
    ...
    function destroy() {
        ...
        try{
            ...
            logging('delete data tblm_segregationother');
            $table->db->trans_commit(); //Commit Trans
