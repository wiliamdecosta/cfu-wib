...
/**
* Json library
* @class Tblm_statuslist_controller
...
class Tblm_statuslist_controller {
    ...
    function read() {
        ...
        $statustypeid_fk = getVarClean('statustypeid_fk','int',0);

        try {

            $ci = & get_instance();
            $ci->load->model('parameter/tblm_statuslist');
            ...
            if(!empty($statustypeid_fk)) {
                $req_param['where'][] = 'statustypeid_fk = '.$statustypeid_fk;
            }
    ...
    function readLov() {
        ...
        $sort = getVarClean('sort','str','statuslistid_pk');
        ...
        try {
            ...
            if(!empty($status_type_code)) {
                $table->setCriteria("upper(status_type.code) like upper('".$status_type_code."')");
            }
