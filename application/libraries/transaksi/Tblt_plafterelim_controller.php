...
/**
* Json library
* @class Tblt_plafterelim_controller
...
class Tblt_plafterelim_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/tblt_plafterelim');
            $table = new Tblt_plafterelim($processcontrolid_pk, $i_search);
    ...
    function do_process() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/tblt_plafterelim');
            $table = new Tblt_plafterelim($i_process_control_id, '');

            $userdata = $ci->session->userdata;

           $sql = "BEGIN "
                    . " pack_PLAfterElim.ProcessPLAfterElim("
    ...
    function cancel_process() {
        ...
        try {
            ...
            $sql = "BEGIN "
                    . " pack_PLAfterElim.CancelPLAfterElim("
                    . " :i_process_control_id, "
                    . " :i_user_name"
                    . "); END;";
    ...
    function download_excel() {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/tblt_plafterelim');
            $table = new Tblt_plafterelim($processcontrolid_pk, '');

            $count = $table->countAll();
            $items = $table->getAll(0, -1);

            startExcel("plafterelim_".$periodid_fk.".xls");
...
/* End of file Tblt_plafterelim_controller.php */