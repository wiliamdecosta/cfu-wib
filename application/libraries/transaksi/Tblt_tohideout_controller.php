...
/**
* Json library
* @class Tblt_tohideout_controller
...
class Tblt_tohideout_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/tblt_tohideout');
            $table = new Tblt_tohideout($processcontrolid_pk, $i_search);
    ...
    function do_process() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/tblt_tohideout');
            $table = new Tblt_tohideout($i_process_control_id, '');

            $userdata = $ci->session->userdata;

           $sql = "BEGIN "
                    . " pack_ToHideOut.ProcessToHideOut("
    ...
    function cancel_process() {
        ...
        try {
            ...
            $sql = "BEGIN "
                    . " pack_ToHideOut.CancelToHideOut("
                    . " :i_process_control_id, "
                    . " :i_user_name"
                    . "); END;";
    ...
    function download_excel() {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/tblt_tohideout');
            $table = new Tblt_tohideout($processcontrolid_pk, '');

            $count = $table->countAll();
            $items = $table->getAll(0, -1);

            startExcel("tohideout_".$periodid_fk.".xls");
