...
/**
* Json library
* @class Tblt_satellitedetail_controller
...
class Tblt_satellitedetail_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/tblt_satellitedetail');
            $table = new Tblt_satellitedetail($periodid_fk, $ubiscode, $i_search);
    ...
    function download_excel() {
            ...
            startExcel("satellitedetail_".$periodid_fk.".xls");
