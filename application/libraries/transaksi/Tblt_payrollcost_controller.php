...
class Tblt_payrollcost_controller {
    ...
    function download_summary() {
            ...
            foreach($items as $item) {
                ...
                $output .= '<td>'.$item['baseslr'].'</td>';
                $output .= '<td>'.$item['mahal'].'</td>';
                $output .= '<td>'.$item['tunjanganpajak'].'</td>';
                $output .= '<td>'.$item['premium'].'</td>';
                $output .= '<td>'.$item['askedir'].'</td>';
                $output .= '<td>'.$item['bbp'].'</td>';
                $output .= '<td>'.$item['adjbbp'].'</td>';
                $output .= '<td>'.$item['lembur'].'</td>';
                $output .= '<td>'.$item['insjabatan'].'</td>';
                $output .= '<td>'.$item['adjinsjabatan'].'</td>';
                $output .= '<td>'.$item['bpjs'].'</td>';
                $output .= '<td>'.$item['dplk'].'</td>';
                $output .= '<td>'.$item['jkk'].'</td>';
                $output .= '<td>'.$item['jht'].'</td>';
                $output .= '<td>'.$item['jkm'].'</td>';
                $output .= '<td>'.$item['bpjsjp'].'</td>';
                $output .= '<td>'.$item['rapelbpjsjp'].'</td>';
                $output .= '<td>'.$item['posaskedir'].'</td>';
                $output .= '<td>'.$item['kopeg'].'</td>';
                $output .= '<td>'.$item['sumb'].'</td>';
                $output .= '<td>'.$item['taspen'].'</td>';
                $output .= '<td>'.$item['rapeltaspen'].'</td>';
                $output .= '<td>'.$item['others'].'</td>';
                $output .= '<td>'.$item['totalsalary'].'</td>';
