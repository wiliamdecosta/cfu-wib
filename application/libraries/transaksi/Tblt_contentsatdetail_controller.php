...
/**
* Json library
* @class Tblt_contentsatdetail_controller
...
class Tblt_contentsatdetail_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/tblt_contentsatdetail');
            $table = new Tblt_contentsatdetail($i_process_control_id, $i_search);
...
/* End of file Tblt_contentsatdetail_controller.php */