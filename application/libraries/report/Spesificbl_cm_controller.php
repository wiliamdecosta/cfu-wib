...
/**
* Json library
* @class Spesificbl_cm_controller
...
class Spesificbl_cm_controller {
     ...
     function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('report/spesificbl_cm');
            $table = new Spesificbl_cm($year_id, $bl_id);
    ...
    function download_excel() {
            ...
            startExcel("Spesificbl_cm_".$year_id.".xls");

            $output = '';
            $output .= '<div style="font-size: 18px; font-weight : bold;"> '.$blname.' </div>';
            $output .= '<div style="font-size: 14px; font-weight : bold;"> Performance Growth YoY Model Current Month '.$year_id.'</div>';
...
/* End of file Spesificbl_cm_controller.php */