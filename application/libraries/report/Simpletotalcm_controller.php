...
/**
* Json library
* @class Simpletotalcm_controller
...
class Simpletotalcm_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('report/simpletotalcm');
            $table = new Simpletotalcm($year_id);
    ...
    function download_excel() {
            ...
            startExcel("simpletotalcm_".$year_id.".xls");

            $output = '';
            $output .= '<div style="font-size: 18px; font-weight : bold;"> P&L CFU Simple Total</div>';
            $output .= '<div style="font-size: 14px; font-weight : bold;"> Model Current Month '.$year_id.'</div>';
...
/* End of file Simpletotalcm_controller.php */