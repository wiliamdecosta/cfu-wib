...
/**
* Json library
* @class Bl_performance_cm_controller
...
class Bl_performance_cm_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('report/bl_performance_cm');
            $table = new Bl_performance_cm($year_id, $bl_id, $budget_ver);
    ...
    function download_excel() {
            ...
            startExcel("Bl_performance_cm_".$year_id.".xls");

            $output = '';
            $output .= '<div style="font-size: 18px; font-weight : bold;"> '.$blname.' </div>';
            $output .= '<div style="font-size: 14px; font-weight : bold;"> Performance Achievement YoY Model Current Month '.$year_id.'</div>';
...
/* End of file Bl_performance_cm_controller.php */