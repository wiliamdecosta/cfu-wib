...
/**
 * Tblt_costdriverentry Model
 *
 */
class Tblt_costdriverentry extends Abstract_model {

    public $table           = "tblt_costdriverentry";
    public $pkey            = "";
    public $alias           = "";
    ...
    public $fromClause      = "table (f_ShowCostDriverEntry(%d, '%s'))";
