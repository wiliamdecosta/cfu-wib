...
/**
 * Tblt_contentsatdetail Model
 *
 */
class Tblt_contentsatdetail extends Abstract_model {
    ...
    public $selectClause    = "s01 subjectcode,
                                s02 itemcode,
                                n01 value1,
                                n02 value2
                              ";

    public $fromClause      = "table (f_ShowDetailInfo(%d, '%s'))";
