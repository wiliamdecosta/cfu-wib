...
/**
 * Tblt_costdriverpl Model
 *
 */
class Tblt_costdriverpl extends Abstract_model {

    public $table           = "tblt_costdriverpl";
    public $pkey            = "";
    public $alias           = "";
    ...
    public $fromClause      = "table (f_ShowCostDriverPL(%d, '%s'))";
...
/* End of file Tblt_costdriverpl.php */