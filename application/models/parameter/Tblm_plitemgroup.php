 ...
 *
 */
class Tblm_plitemgroup extends Abstract_model {

    public $table           = "tblm_plitemgroup";
    public $pkey            = "plitemgroupid_pk";
    public $alias           = "a";

    public $fields          = array(
                                'plitemgroupid_pk'  => array('pkey' => true, 'type' => 'int', 'nullable' => true, 'unique' => true, 'display' => 'PLITEMGROUPID_PK'),
    ...
    public $selectClause    = "a.plitemgroupid_pk, a.code, a.listingno, a.description, a.creationdate, a.createdby, a.updateddate, a.updatedby,
                                        to_char(a.updateddate, 'DD-MON-YYYY HH24:MI') lastupdateddate, a.updatedby lastupdatedby
                                    ";
    public $fromClause      = "tblm_plitemgroup a";
