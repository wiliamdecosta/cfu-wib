 ...
 *
 */
class Tblm_activitygroup extends Abstract_model {

    public $table           = "tblm_activitygroup";
    public $pkey            = "activitygroupid_pk";
    public $alias           = "a";

    public $fields          = array(
                                'activitygroupid_pk'  => array('pkey' => true, 'type' => 'int', 'nullable' => true, 'unique' => true, 'display' => 'ACTIVITYGROUPID_PK'),
    ...
    public $selectClause    = "a.activitygroupid_pk, a.code, a.listingno, a.description, a.creationdate, a.createdby, a.updateddate, a.updatedby,
                                        to_char(a.updateddate, 'DD-MON-YYYY HH24:MI') lastupdateddate, a.updatedby lastupdatedby
                                    ";
    public $fromClause      = "tblm_activitygroup a";
