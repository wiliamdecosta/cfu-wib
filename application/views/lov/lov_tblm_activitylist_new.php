            ...
            <div class="modal-body">
                ...
                <thead>
                  <tr>
                     ...
                     <th data-column-id="code"  data-width="120">Activity Code</th>
        ...
        $("#modal_lov_tblm_activitylist_grid_selection").bootgrid({
             formatters: {
                "opt-edit" : function(col, row) {
                    return '<a href="javascript:;" title="Set Value" onclick="modal_lov_tblm_activitylist_set_value(\''+ row.activitylistid_pk +'\', \''+ row.code +'\', \''+ row.actlistname +'\')" class="blue"><i class="fa fa-pencil-square-o bigger-130"></i></a>';
                }
             },
             rowCount:[5,10],
             ajax: true,
