...
<script>
    ...
    function modal_lov_tblm_costdriver_prepare_table() {
        ...
        $("#modal_lov_tblm_costdriver_grid_selection").bootgrid({
             ...
             url: '<?php echo WS_BOOTGRID."parameter.tblm_costdriver_controller/readLovNew"; ?>',
             selection: true,
             sorting:true
        });
