...
<script>
    function showData(){
        ...
        jQuery("#grid-table").jqGrid('setGridParam',{
            url: '<?php echo WS_JQGRID."parameter.tblm_segregationact_controller/read"; ?>',
            postData: {
                i_search : i_search,
                ubiscode : ubiscode
            }
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."parameter.tblm_segregationact_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'segregationactid_pk', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
            ...
            editurl: '<?php echo WS_JQGRID."parameter.tblm_segregationact_controller/crud"; ?>',
            caption: "Ind. Cost Activity"
