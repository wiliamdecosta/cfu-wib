...
<script>
    function showData(){
        ...
        jQuery("#grid-table").jqGrid('setGridParam',{
            url: '<?php echo WS_JQGRID."parameter.tblm_pca_controller/read"; ?>',
            postData: {
                i_search : i_search,
                ubiscode : ubiscode
            }
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."parameter.tblm_pca_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                ...
                {label: 'PCA In Data Source',name: 'pcainsourcedisplay',width: 120, align: "left"},
                {label: 'PCA In Source',name: 'pcainsource',width: 200, hidden:true, align: "left",editable: true,
                    edittype:'text',
                    editoptions: {
                        size: 30,
                        maxlength:48
            ...
            editurl: '<?php echo WS_JQGRID."parameter.tblm_pca_controller/crud"; ?>',
            caption: "PCA"
