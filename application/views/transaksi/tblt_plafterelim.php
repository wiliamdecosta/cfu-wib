...
<div class="row">
    <div class="col-xs-12">
            ...
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="javascript:;" data-toggle="tab" aria-expanded="true" id="tab-1">
                        <i class="blue"></i>
                        <strong> After_Elimination_PL </strong>
                    </a>
                </li>
                <li class="">
        ...
        <div class="tab-content no-border">
            ...
            <h3> After_Elimination_PL <?php echo '('.$this->input->post('periodid_fk').')'; ?></h3>
            ...
            <div class="space-4"></div>
            <div class="row" id="btn-group-plafterelim-action" style="display:none;">
                ...
                <div class="col-xs-6">
                    ...
                    <button class="btn btn-primary" id="btn-download" onclick="downloadPlAfterElim();">Download</button>
                </div>
            </div>
        </div>
    </div>
...
$("#tab-2").on("click", function(event) {
    ...
    loadContentWithParams("transaksi.tblt_processsummary", {
        ...
        processcode : 'After_Elimination_PL',
    ...
    function showData(){
        ...
        jQuery(function($) {
            jQuery("#grid-table").jqGrid('setGridParam',{
                url: '<?php echo WS_JQGRID."transaksi.tblt_plafterelim_controller/read"; ?>',
                postData: {
                    i_search : i_search,
                    processcontrolid_pk : <?php echo $this->input->post('processcontrolid_pk'); ?>,
                    ubiscode: ubiscode
...
<script>
    function buttonMode(statuscode) {
        ...
        if(isupdatable == 'Y') {
            $('#btn-group-plafterelim-action').show();
    ...
    function loadForm(statuscode) {
        loadContentWithParams("transaksi.tblt_plafterelim", {
            i_batch_control_id : <?php echo $this->input->post('i_batch_control_id'); ?>,
            periodid_fk : <?php echo $this->input->post('periodid_fk'); ?>,
            isupdatable : '<?php echo $this->input->post('isupdatable'); ?>',
...
<script>
    ...
    function doProcess() {
            ...
            var ajaxOptions = {
                url: '<?php echo WS_JQGRID."transaksi.tblt_plafterelim_controller/do_process"; ?>',
                type: "POST",
                dataType: "json",
    ...
    function cancelProcess() {
            ...
            var ajaxOptions = {
                url: '<?php echo WS_JQGRID."transaksi.tblt_plafterelim_controller/cancel_process"; ?>',
                type: "POST",
                dataType: "json",
                data: { i_process_control_id:i_process_control_id,
                        i_batch_control_id : i_batch_control_id },
...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."transaksi.tblt_plafterelim_controller/crud"; ?>',
            ...
            editurl: '<?php echo WS_JQGRID."transaksi.tblt_plafterelim_controller/crud"; ?>',
            caption: "After_Elimination_PL"
