    ...
    function showData(){
        ...
        jQuery(function($) {
            jQuery("#grid-table").jqGrid('setGridParam',{
                url: '<?php echo WS_JQGRID."transaksi.tblt_verticalalloc_controller/read"; ?>',
                postData: {
                    i_search : i_search,
                    processcontrolid_pk : <?php echo $this->input->post('processcontrolid_pk'); ?>,
                    ubiscode: ubiscode
...
<script>
    ...
    function loadForm(statuscode) {
        loadContentWithParams("transaksi.tblt_verticalalloc", {
            i_batch_control_id : <?php echo $this->input->post('i_batch_control_id'); ?>,
            periodid_fk : <?php echo $this->input->post('periodid_fk'); ?>,
            isupdatable : '<?php echo $this->input->post('isupdatable'); ?>',
...
<script>
    ...
    function doProcess() {
            ...
            var ajaxOptions = {
                url: '<?php echo WS_JQGRID."transaksi.tblt_verticalalloc_controller/do_process"; ?>',
                type: "POST",
                dataType: "json",
    ...
    function cancelProcess() {
            ...
            var ajaxOptions = {
                url: '<?php echo WS_JQGRID."transaksi.tblt_verticalalloc_controller/cancel_process"; ?>',
                type: "POST",
                dataType: "json",
                data: { i_process_control_id:i_process_control_id,
                            i_batch_control_id:i_batch_control_id },
...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."transaksi.tblt_verticalalloc_controller/crud"; ?>',
            postData: { processcontrolid_pk : <?php echo $this->input->post('processcontrolid_pk'); ?>},
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'Activity',name: 'activitygabung',width: 200, align: "left"},
                {label: 'Overhead 1',name: 'overheadgabung1',width: 350, align: "left"},
                {label: 'Overhead 2',name: 'overheadgabung2',width: 200, align: "left"},
            ...
            editurl: '<?php echo WS_JQGRID."transaksi.tblt_verticalalloc_controller/crud"; ?>',
