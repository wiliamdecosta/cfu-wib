                   ...
                   <table class="table table-bordered table-hover table-condensed">
                        <thead>
                            <tr>
                                ...
                                <th>Activity</th>
                                <th align="center">Need PCA?</th>
                            </tr>
                        </thead>
                        <tbody id="tbl-costmap">
...
<script>
    ...
    function loadForm(statuscode) {
        loadContentWithParams("transaksi.tblt_costmap_new", {
            i_batch_control_id : <?php echo $this->input->post('i_batch_control_id'); ?>,
            periodid_fk : <?php echo $this->input->post('periodid_fk'); ?>,
            isupdatable : '<?php echo $this->input->post('isupdatable'); ?>',
...
<script>
    function loadDataTable(i_search, ubiscode) {
        $( "#tbl-costmap" ).html( 'Loading...');
        $.ajax({
            url: '<?php echo WS_JQGRID."transaksi.tblt_costmap_controller/readTable"; ?>',
            type: "POST",
            data: {
                i_search : i_search,
