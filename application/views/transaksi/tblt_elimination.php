...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="tab-content no-border">
            ...
            <div class="space-4"></div>
            <div class="row" id="btn-group-elimination" style="display:none;">
                    <form method="post" id="form-submit">
                        <div class="col-xs-4">
                            <span id="label-upload" class="red">Pilih File Upload : </span><input type="file" id="filename" name="filename">
                        </div>
                        <div class="col-xs-6">
                            <button class="btn btn-success" type="button" id="btn-uploaddata" onclick="doUpload();">Upload Elimination</button>
                            <button class="btn btn-warning" type="button" id="btn-cancel" onclick="cancelProcess();">Cancel Elimination</button>
                            <button class="btn btn-primary" type="button" id="btn-download" onclick="downloadXls();">Download Elimination</button>
                        </div>
                    </form>
            </div>
        </div>
...
<?php
    ...
    $table = new Tblt_elimination($this->input->post('processcontrolid_pk'), '');
...
$("#tab-log").on("click", function(event) {
    ...
    loadContentWithParams("transaksi.tblp_logprocesscontrol_elimination", {
    ...
    function showData(){
        ...
        jQuery(function($) {
            jQuery("#grid-table").jqGrid('setGridParam',{
                url: '<?php echo WS_JQGRID."transaksi.tblt_elimination_controller/read"; ?>',
                postData: {
                    i_search : i_search,
                    processcontrolid_pk : <?php echo $this->input->post('processcontrolid_pk'); ?>
                }
...
<script>
    ...
    function loadForm(statuscode) {
        loadContentWithParams("transaksi.tblt_elimination", {
            i_batch_control_id : <?php echo $this->input->post('i_batch_control_id'); ?>,
            periodid_fk : <?php echo $this->input->post('periodid_fk'); ?>,
            isupdatable : '<?php echo $this->input->post('isupdatable'); ?>',
...
<script>
    ...
    function doUpload() {
            ...
            var ajaxOptions = {
                url: '<?php echo WS_JQGRID."transaksi.tblt_elimination_controller/do_upload"; ?>',
                type: "POST",
                dataType: "json",
                data: formData,
    ...
    function cancelProcess() {
            ...
            var ajaxOptions = {
                url: '<?php echo WS_JQGRID."transaksi.tblt_elimination_controller/cancel_process"; ?>',
                type: "POST",
                dataType: "json",
    ...
    function downloadXls() {
            ...
            var url = "<?php echo WS_JQGRID . "transaksi.tblt_elimination_controller/download_excel/?"; ?>";
...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."transaksi.tblt_elimination_controller/crud"; ?>',
            ...
            colModel: [
                ...
                {label: 'International Traffic',name: 'intltrafficamount',width: 150, align: "right", formatter:function(cellvalue, options, rowObject) {
                    if(cellvalue != null){
                        return $.number(cellvalue, 2);
                    }else{
                        return '';
                ...
                {label: 'International Network',name: 'intlnetworkamount',width: 150, align: "right", formatter:function(cellvalue, options, rowObject) {
                    if(cellvalue != null){
                        return $.number(cellvalue, 2);
                    }else{
                        return '';
                ...
                {label: 'Carrier Total',name: 'totalcarrieramount',width: 150, align: "right", formatter:function(cellvalue, options, rowObject) {
                    if(cellvalue != null){
                        return $.number(cellvalue, 2);
                    }else{
                        return '';
                ...
                {label: 'International Adjacent',name: 'intladjacentamount',width: 150, align: "right", formatter:function(cellvalue, options, rowObject) {
                    if(cellvalue != null){
                        return $.number(cellvalue, 2);
                    }else{
                        return '';
                ...
                {label: 'PL Item Group',name: 'plgroupname',width: 250, align: "left"}
            ],
            height: '100%',
            autowidth: true,
            viewrecords: true,
            ...
            editurl: '<?php echo WS_JQGRID."transaksi.tblt_elimination_controller/crud"; ?>',
