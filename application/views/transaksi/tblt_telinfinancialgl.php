...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="tab-content no-border">
            ...
            <div class="space-4"></div>
            <div class="row" id="btn-group-telinfinancialgl" style="display:none;">
                    <form method="post" id="form-submit">
                        <div class="col-xs-4">
                            <span id="label-upload" class="red">Pilih File Upload : </span><input type="file" id="filename" name="filename">
                        </div>
                        <div class="col-xs-6">
                            <button class="btn btn-success" type="button" id="btn-uploaddata" onclick="doUpload();">Upload Financial GL</button>
                            <button class="btn btn-warning" type="button" id="btn-cancel" onclick="cancelProcess();">Cancel Financial GL</button>
                        </div>
                    </form>
            </div>
        </div>
...
<?php
    ...
    $table = new Tblt_telinfinancialgl($this->input->post('processcontrolid_pk'), '');
...
$("#tab-telinfinancialcc").on("click", function(event) {
    event.stopPropagation();
    ...
    function showData(){
        ...
        jQuery(function($) {
            jQuery("#grid-table").jqGrid('setGridParam',{
                url: '<?php echo WS_JQGRID."transaksi.tblt_telinfinancialgl_controller/read"; ?>',
                postData: {
                    i_search : i_search,
                    processcontrolid_pk : <?php echo $this->input->post('processcontrolid_pk'); ?>
                }
...
<script>
    ...
    function buttonMode(statuscode) {
        ...
        if(isupdatable == 'Y') {
            $('#btn-group-telinfinancialgl').show();
...
<script>
    ...
    function doUpload() {
            ...
            var ajaxOptions = {
                url: '<?php echo WS_JQGRID."transaksi.tblt_telinfinancialgl_controller/do_upload"; ?>',
                type: "POST",
                dataType: "json",
                data: formData,
    ...
    function cancelProcess() {
            ...
            var ajaxOptions = {
                url: '<?php echo WS_JQGRID."transaksi.tblt_telinfinancialgl_controller/cancel_process"; ?>',
                type: "POST",
                dataType: "json",
...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."transaksi.tblt_telinfinancialgl_controller/crud"; ?>',
            ...
            colModel: [
                ...
                {label: 'Telin SG',name: 'telinsg',width: 150, align: "right", formatter:function(cellvalue, options, rowObject) {
                    return $.number(cellvalue, 2);
                }},
                {label: 'Telin HK',name: 'telinhk',width: 150, align: "right", formatter:function(cellvalue, options, rowObject) {
                    return $.number(cellvalue, 2);
                }},
                {label: 'TTL',name: 'ttl',width: 150, align: "right", formatter:function(cellvalue, options, rowObject) {
                    return $.number(cellvalue, 2);
                }},
                {label: 'Telin AU',name: 'telinau',width: 150, align: "right", formatter:function(cellvalue, options, rowObject) {
                    return $.number(cellvalue, 2);
                }},
            ...
            editurl: '<?php echo WS_JQGRID."transaksi.tblt_telinfinancialgl_controller/crud"; ?>',
            caption: "Financial GL"
