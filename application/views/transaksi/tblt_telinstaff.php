...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="tab-content no-border">
            ...
            <div class="space-4"></div>
            <div class="row" id="btn-group-telinstaff" style="display:none;">
                    <form method="post" id="form-submit">
                        <div class="col-xs-4">
                            <span id="label-upload" class="red">Pilih File Upload : </span><input type="file" id="filename" name="filename">
                        </div>
                        <div class="col-xs-6">
                            <button class="btn btn-success" type="button" id="btn-uploaddata" onclick="doUpload();">Upload Staff Data</button>
                            <button class="btn btn-warning" type="button" id="btn-cancel" onclick="cancelProcess();">Cancel Staff Data</button>
                        </div>
                    </form>
            </div>
        </div>
...
<?php
    ...
    $table = new Tblt_telinstaff($this->input->post('processcontrolid_pk'), '');
    ...
    function showData(){
        ...
        jQuery(function($) {
            jQuery("#grid-table").jqGrid('setGridParam',{
                url: '<?php echo WS_JQGRID."transaksi.tblt_telinstaff_controller/read"; ?>',
                postData: {
                    i_search : i_search,
                    processcontrolid_pk : <?php echo $this->input->post('processcontrolid_pk'); ?>
                }
...
<script>
    ...
    function loadForm(statuscode) {
        loadContentWithParams("transaksi.tblt_telinstaff", {
            i_batch_control_id : <?php echo $this->input->post('i_batch_control_id'); ?>,
            periodid_fk : <?php echo $this->input->post('periodid_fk'); ?>,
            isupdatable : '<?php echo $this->input->post('isupdatable'); ?>',
...
<script>
    ...
    function doUpload() {
            ...
            var ajaxOptions = {
                url: '<?php echo WS_JQGRID."transaksi.tblt_telinstaff_controller/do_upload"; ?>',
                type: "POST",
                dataType: "json",
                data: formData,
    ...
    function cancelProcess() {
            ...
            var ajaxOptions = {
                url: '<?php echo WS_JQGRID."transaksi.tblt_telinstaff_controller/cancel_process"; ?>',
                type: "POST",
                dataType: "json",
...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."transaksi.tblt_telinstaff_controller/crud"; ?>',
            ...
            editurl: '<?php echo WS_JQGRID."transaksi.tblt_telinstaff_controller/crud"; ?>',
            caption: "Telin Staff"
